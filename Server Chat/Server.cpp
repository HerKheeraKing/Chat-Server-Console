		...
		for (int i = 0; i < numReady; i++)
		{
			...
			else 
			{
				...
				{ 
					...
					if (command == "@help" || command == "@clear" || command.substr(0, 9) == "@register" || command.substr(0, 6) == "@login" || command == "@logout" || command == "@getlist" || command == "@getlog" || command.substr(0, 5) == "@send") 
					{
